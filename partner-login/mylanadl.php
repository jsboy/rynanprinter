...
function ctck()
{
     ...
     if(sds == null){
        mylanart("You are using a free package.\n You are not allowed to remove the tag.\n");
     }
...
$logs = @mysql_query("SELECT * from mylana where printers 
like 'RYNAN R20' and type like 'Firmware' order by timecreate desc");
...
echo "<th>". $log['type']. "</th>";
echo "<th><a href=\"https://rynantech.com/partner-login/mylanaclick.php?id=".$log['id']."\"><img src='https://rynantech.com/partner-login/sites/images/dl.png".$row['image_name']."'></a></th>";
...
//echo "<td><a href=\"https://rynantech.com/partner-login/mylana/VJET/$log[link]\" onclick=\"khoa();\">$log[link]</a></td>";
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1000' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1010' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1020' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1040' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1040H' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1040He' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1040S' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'B1040P' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'B1060' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'B1060P' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'B1060H' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1200' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1200e' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'IOJ100' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'IOJ200' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers 
like 'RYNAN R20' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1000' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1010' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1020' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1040' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1040H' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1040He' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1040S' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'B1040P' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'B1060' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'B1060P' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'B1060H' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1200' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1200e' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'IOJ100' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'IOJ200' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers 
like 'RYNAN R20' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1000' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1010' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1020' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1040' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1040H' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1040He' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1040S' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'B1040P' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'B1060' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'B1060P' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'B1060H' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1200' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1200e' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'IOJ100' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'IOJ200' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers 
like 'RYNAN R20' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1000' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1010' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1020' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1040' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1040H' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1040He' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1040S' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'B1040P' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'B1060' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'B1060P' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'B1060H' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1200' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1200e' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'IOJ100' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'IOJ200' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers 
like 'RYNAN R20' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1000' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1010' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1020' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1040' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1040H' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1040He' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1040S' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'B1040P' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'B1060' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'B1060P' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'B1060H' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1200' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1200e' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'IOJ100' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'IOJ200' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers 
like 'RYNAN R20' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1000' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1010' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1020' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1040' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1040H' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1040He' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1040S' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'B1040P' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'B1060' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'B1060P' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'B1060H' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1200' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'VJET1200e' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'IOJ100' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from mylana where printers like 'IOJ200' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
