...
<tr>
<td><a href="/partner-login/rynanacre.php" class="hrlink"> <img src="sites/images/createdownload.png" border="0" /></a></td>
</tr>
</table>
</div>
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynana where printers like 'InkFeeder8IOJ200' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
