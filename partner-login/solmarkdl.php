...
function ctck()
{
     ...
     if(sds == null){
        solmarkrt("You are using a free package.\n You are not allowed to remove the tag.\n");
     }
...
echo "<th>". $log['type']. "</th>";
echo "<th><a href=\"https://rynantech.com/partner-login/solmarkclick.php?id=".$log['id']."\"><img src='https://rynantech.com/partner-login/sites/images/dl.png".$row['image_name']."'></a></th>";
...
//echo "<td><a href=\"https://rynantech.com/partner-login/solmark/VJET/$log[link]\" onclick=\"khoa();\">$log[link]</a></td>";
