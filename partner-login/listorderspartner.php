...
<table border="0" cellpadding="0" cellspacing="0" width="981"  >
	<tr>
		...
		<div><p align="justify" class="mem_acc">&nbsp;&nbsp;&nbsp;&nbsp;Orders History</p></div>
...
SELECT orderdetails.orderdetailsid, orderdetails.dateorder, orderdetails.dateedit, members.fullname, members.user, orderdetails.productname, orderdetails.quantity, orderdetails.price, orderdetails.total
    FROM orderdetails
    JOIN members ON orderdetails.memberid = members.id WHERE memberid = $user_id order by dateorder desc
...
echo "<td><a href=\"editlistorderspartner.php?id=$log[orderdetailsid]\">Edit</a></td>";
echo "<td><a href=\"deleteorderspartner.php?id=$log[orderdetailsid]\" onclick=\"return makesure();\">Delete</a></td>";
