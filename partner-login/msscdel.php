...
<title>MSSC DELETE LINK </title>	<link href="http://rynantech.com/wp-content/themes/solid-v2-wp/favicon.ico" rel="shortcut icon" type="image/x-icon" />
...
<table border="0" cellpadding="0" cellspacing="0" width="977">
	<tr>
		...
		<div><p align="justify" class="mem_acc">&nbsp;&nbsp;&nbsp;&nbsp;Delete link mssc
</p></div>
...
$sql="DELETE FROM mssc WHERE id='$id'";
