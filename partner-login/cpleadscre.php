...
if ( $_GET['act'] == "do" )
{
 ...
 //       exit;
  //  }
    ...
    @$a=mysql_query("INSERT INTO leads (company, country, classification, address, contact,phone, email, website, notes, timecreate) VALUES ('{$company}', '{$country}', '{$classification}', '{$address}', '{$contact}', '{$phone}', '{$email}', '{$website}', '{$notes}', '{$timereg}')");
...
<table border="0" cellpadding="0" cellspacing="0" width="981"  >
	<tr>
		...
		<div><p align="justify" class="mem_acc">&nbsp;&nbsp;&nbsp;&nbsp;Create new LEADS
...
<?php
 // Thông báo hoàn tất việc tạo tài khoản
    if ($a)
        print "The Company {$company} has been created <a href='cpleads.php'>.     Click here to back</a>";
    else
        print " ";
...
<form action="cpleadscre.php?act=do" method="post">
