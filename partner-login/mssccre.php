...
if ( $_GET['act'] == "do" )
{
   ...
   // $vercode = addslashes( $_POST['vercode'] );
    ...
    @$a=mysql_query("INSERT INTO mssc (filename, type, printers, link, notes, timecreate) VALUES ('{$filename}', '{$type}', '{$printers}', '{$link}', '{$notes}', '{$timereg}')");
...
<table border="0" cellpadding="0" cellspacing="0" width="981"  >
	<tr>
		...
		<div><p align="justify" class="mem_acc">&nbsp;&nbsp;&nbsp;&nbsp;Create Files for mssc
	...
	<div><p class="backtoindex"><a href="/partner/mssccp.php" class="hrlink"><font size="12" color="#fff" class="rightpnhome">Back to index</p></font></a></div>
...
<?php
 // Thông báo hoàn tất việc tạo tài khoản
    if ($a)
        print "The account {$username} has been created <a href='mssccp.php'>.     Click here to list download</a>";
    else
        print " ";
...
<form action="mssccre.php?act=do" method="post">
	<div class="row2">
			<div class="row2">
				<div class="val">
