...
if( isset ($_GET['edit']))
    ...
    $res = mysql_query("SELECT * FROM leads WHERE id='$id'");
...
<table border="0" cellpadding="0" cellspacing="0" width="981">
	<tr>
		...
		<div><p align="justify" class="mem_acc">&nbsp;&nbsp;&nbsp;&nbsp;Edit Information</p></div>
	...
	<div><p class="backtoindex"><a href="/partner-login/cpleads.php" class="hrlink"><font size="12" color="#fff" class="rightpnhome">Back to index</p></font></a></div>
...
<?php
    ...
    $thanhcong='<p align="justify" style="color: #FF0000; margin-left:252px; margin-right:22px; margin-top:12px; margin-bottom:12px"> Edit sucessfull <a href="./cpleads.php">Back</a></p>';
...
echo "<meta http-equiv='refresh' content='0;url=/partner-login/cpleads.php'>";
...
<div id="editaccount">
 ...
 <select name="printers" id="printers"   style="width: 260px">
	...
	<!-- <div><textarea rows="4" cols="50" name="notes" value="<?php echo $row['notes']; ?>" id="notes"></textarea></div>
	 -->				</div>
                 </div>
			</div>
<!-- 	<div class="row2">
