...
function ctck()
{
     ...
     if(sds == null){
        rynanbrt("You are using a free package.\n You are not allowed to remove the tag.\n");
     }
...
echo "<th>". $log['type']. "</th>";
echo "<th><a href=\"https://rynantech.com/partner-login/rynanbclick.php?id=".$log['id']."\"><img src='https://rynantech.com/partner-login/sites/images/dl.png".$row['image_name']."'></a></th>";
...
//echo "<td><a href=\"https://rynantech.com/partner-login/rynanb/VJET/$log[link]\" onclick=\"khoa();\">$log[link]</a></td>";
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanb where printers like 'InkFeeder8' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
