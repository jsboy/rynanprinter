...
<table border="0" cellpadding="0" cellspacing="0" width="977">
	<tr>
		...
		<div><p align="justify" class="mem_acc">&nbsp;&nbsp;&nbsp;&nbsp;ADMIN - SOLMARK</p></div>
...
<tr>
<td><a href="/partner-login/solmarkcre.php" class="hrlink"> <img src="sites/images/createdownload.png" border="0" /></a></td>
</tr>
</table>
</div>
...
$logs = @mysql_query("SELECT * from solmark where printers like 'R20 PRO' and type like 'Firmware' order by timecreate desc");
...
echo "<th>". $log['type']. "</th>";
echo "<th><a href=\"http://rynantech.com/partner-login/solmarkclick.php?id=".$log['id']."\"><img src='http://www.rynantech.com/partner-login/sites/images/dl.png".$row['image_name']."'></a></th>";
echo "<th>". $log['notes']. "</th>";
echo "<th>". $log['views']. "</th>";
echo "<th>". $createDate. "</th>";
echo "<th><a href=\"solmarkedit.php?id=$log[id]\"><img src='http://www.rynantech.com/partner-login/sites/images/edit.png".$row['image_name']."'></a></th>";
echo "<th><a href=\"solmarkdel.php?id=$log[id]\" onclick=\"return makesure();\"><img src='http://www.rynantech.com/partner-login/sites/images/delete.png".$row['image_name']."'></a></th>";
//echo "<td>". $log['id']. "</td>";
//echo "<td>". $log['printers']. "</td>";
//echo "<td>". $log['link']. "</td>";
//echo "<td>". $log['lastupdate']. "</td>";
//echo "<td>". $log['views']. "</td>";
//echo "<td><a href=\"http://rynantech.com/partner-login/solmark/VJET/$log[link]\" onclick=\"khoa();\">$log[link]</a></td>";
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1000' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1010' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1020' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1040' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1040H' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1040He' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1040S' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'B1040P' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1200' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1200e' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'IOJ100' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'IOJ200' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'R20 PRO' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1000' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1010' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1020' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1040' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1040H' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1040He' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1040S' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'B1040P' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1200' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1200e' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'IOJ100' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'IOJ200' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'R20 PRO' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1000' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1010' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1020' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1040' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1040H' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1040He' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1040S' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'B1040P' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1200' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1200e' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'IOJ100' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'IOJ200' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'R20 PRO' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1000' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1010' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1020' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1040' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1040H' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1040He' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1040S' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'B1040P' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1200' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1200e' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'IOJ100' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'IOJ200' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'R20 PRO' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1000' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1010' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1020' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1040' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1040H' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1040He' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1040S' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'B1040P' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1200' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1200e' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'IOJ100' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'IOJ200' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'R20 PRO' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1000' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1010' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1020' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1040' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1040H' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1040He' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1040S' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'B1040P' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1200' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'VJET1200e' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'IOJ100' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'IOJ200' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'R20 PRO' and type like 'videos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'W1000' and type like 'videos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'R1010' and type like 'videos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'R1010P' and type like 'videos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'W1020' and type like 'videos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'B1040' and type like 'videos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'B1040H Aluminum' and type like 'videos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'B1040H Plastic' and type like 'videos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'B1040S' and type like 'videos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'B1040P' and type like 'videos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'B1060' and type like 'videos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'B1060P' and type like 'videos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'B1060H' and type like 'videos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like '1200' and type like 'videos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like '1200E' and type like 'videos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like '1200Plus' and type like 'videos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like '1200EG' and type like 'videos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like '2172C' and type like 'videos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'IOJ100' and type like 'videos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'IOJ200' and type like 'videos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'InkFeeder8' and type like 'videos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'R20 PRO' and type like 'photos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'W1000' and type like 'photos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'R1010' and type like 'photos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'R1010P' and type like 'photos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'W1020' and type like 'photos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'B1040' and type like 'photos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'B1040H Aluminum' and type like 'photos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'B1040H Plastic' and type like 'photos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'B1040S' and type like 'photos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'B1040P' and type like 'photos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'B1060' and type like 'photos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'B1060P' and type like 'photos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'B1060H' and type like 'photos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like '1200' and type like 'photos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like '1200E' and type like 'photos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like '1200Plus' and type like 'photos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like '1200EG' and type like 'photos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like '2172C' and type like 'photos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'IOJ100' and type like 'photos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'IOJ200' and type like 'photos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from solmark where printers like 'InkFeeder8' and type like 'photos' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
