...
function ctck()
{
     ...
     if(sds == null){
        mylanbrt("You are using a free package.\n You are not allowed to remove the tag.\n");
     }
...
$logs = @mysql_query("SELECT * from mylanb where printers 
...
echo "<th>". $log['type']. "</th>";
echo "<th><a href=\"https://rynantech.com/partner-login/mylanbclick.php?id=".$log['id']."\"><img src='https://rynantech.com/partner-login/sites/images/dl.png".$row['image_name']."'></a></th>";
...
//echo "<td><a href=\"https://rynantech.com/partner-login/mylanb/VJET/$log[link]\" onclick=\"khoa();\">$log[link]</a></td>";
