...
<table border="0" cellpadding="0" cellspacing="0" width="981"  >
	<tr>
		...
		<div><p align="justify" class="mem_acc">&nbsp;&nbsp;&nbsp;&nbsp;THE DISTRIBUTORS</p></div>
...
$logs = @mysql_query("SELECT * from distributors order by timecreate desc LIMIT 1");
...
<div class="onecolumn">
    <div class="header">
        <span>THE DISTRIBUTORS</span>
<div style="margin: 5px 0px 0px 720px">
<a href="/partner-login/exportdistributors.php" class="hrlink"> <img src="sites/images/exportexcel2.png" border="0" width="30" height="29" /></a></div>
<div style="margin:-30px 0px 0px 765px">
<a href="/partner-login/cpleadscre.php" class="hrlink"> <img src="sites/images/createdownload.png" border="0" /></a></div>
</div>
...
//$logs = @mysql_query("SELECT * from distributors where printers like 'Others' order by timecreate desc");

$logs = @mysql_query("SELECT * from distributors order by timecreate desc");
...
//echo "<td><a href=\"http://rynantech.com/partner-login/cpdistributorsclick.php?id=".$log['id']."\"><img src='http://www.rynantech.com/partner-login/sites/images/dl.png".$row['image_name']."'></a></td>";
...
echo "<td><a href=\"cpdistributorsedit.php?id=$log[id]\"><img src='http://www.rynantech.com/partner-login/sites/images/edit.png".$row['image_name']."'></a></td>";
echo "<td><a href=\"cpdistributorsdel.php?id=$log[id]\" onclick=\"return makesure();\"><img src='http://www.rynantech.com/partner-login/sites/images/delete.png".$row['image_name']."'></a></td>";
