...
function ctck()
{
     ...
     if(sds == null){
        hitachirt("You are using a free package.\n You are not allowed to remove the tag.\n");
     }
...
echo "<th>". $log['type']. "</th>";
echo "<th><a href=\"https://rynantech.com/partner-login/hitachiclick.php?id=".$log['id']."\"><img src='https://rynantech.com/partner-login/sites/images/dl.png".$row['image_name']."'></a></th>";
...
//echo "<td><a href=\"https://rynantech.com/partner-login/hitachi/VJET/$log[link]\" onclick=\"khoa();\">$log[link]</a></td>";
...
<div id="HTJ-4400-us" class="tabcontent" style="display: block;" >
<table id="tracelog1" width="909" border="0" align="center">
<?php
...
<div id="HTJ-1100-videos" class="tabcontent" style="display: block;" >
<table id="tracelog1" width="909" border="0" align="center">
<?php
...
<div id="HTJ-4400-videos" class="tabcontent" style="display: block;" >
<table id="tracelog1" width="909" border="0" align="center">
<?php
...
<div id="HTJ-4400-photos" class="tabcontent" style="display: block;" >
<table id="tracelog1" width="909" border="0" align="center">
<?php
