...
if ( $_GET['act'] == "do" )
{
   ...
   // $vercode = addslashes( $_POST['vercode'] );
    ...
    @$a=mysql_query("INSERT INTO cyklop (filename, type, printers, link, notes, timecreate) VALUES ('{$filename}', '{$type}', '{$printers}', '{$link}', '{$notes}', '{$timereg}')");
...
<title>Cyklop Create files for partner</title>
...
<table border="0" cellpadding="0" cellspacing="0" width="977"  >
	<tr>
		...
		<div><p align="justify" class="mem_acc">&nbsp;&nbsp;&nbsp;&nbsp;Create Files for Cyklop
...
<?php
 // Thông báo hoàn tất việc tạo tài khoản
    if ($a)
        print "The account {$username} has been created <a href='cyklopcp.php'>.     Click here to list download</a>";
    else
        print " ";
...
<form action="cyklopcre.php?act=do" method="post">
	<div class="row2">
			<div class="row2">
				<div class="val">
