...
if ( $_GET['act'] == "do" )
{
 ...
 //       exit;
  //  }
    ...
    @$a=mysql_query("INSERT INTO distributors (company, country, classification, address, contact,phone, email, website, notes, timecreate) VALUES ('{$company}', '{$country}', '{$classification}', '{$address}', '{$contact}', '{$phone}', '{$email}', '{$website}', '{$notes}', '{$timereg}')");
...
<title>Create new distributors</title>
...
<table border="0" cellpadding="0" cellspacing="0" width="981"  >
	<tr>
		...
		<div><p align="justify" class="mem_acc">&nbsp;&nbsp;&nbsp;&nbsp;Create new Distributors
	...
	<div><p class="backtoindex"><a href="/partner-login/cpdistributors.php" class="hrlink"><font size="12" color="#fff" class="rightpnhome">Back to index</p></font></a></div>
...
<?php
 // Thông báo hoàn tất việc tạo tài khoản
    if ($a)
        print "The Company {$company} has been created <a href='cpdistributors.php'>.     Click here to back</a>";
    else
        print " ";
...
<form action="cpdistributorscre.php?act=do" method="post">
