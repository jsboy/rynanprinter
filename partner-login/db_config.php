...
$db_password    = "root";//Can thay doi theo mat khau truy cap MySQL
...
if(function_exists('mysql_connect')) {
    ...
    $conn=mysqli_connect("localhost", $db_username, $db_password) or die("Không thể kết nối đến MySQL server");
}
