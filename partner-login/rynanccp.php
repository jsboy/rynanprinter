...
<table border="0" cellpadding="0" cellspacing="0" width="977">
	<tr>
		...
		<div><p align="justify" class="mem_acc">&nbsp;&nbsp;&nbsp;&nbsp;ADMIN - RYNAN C</p></div>
...
<tr>
<td><a href="/partner-login/rynanccre.php" class="hrlink"> <img src="sites/images/createdownload.png" border="0" /></a></td>
</tr>
</table>
</div>
...
$logs = @mysql_query("SELECT * from rynanc where printers 
like 'R20 PRO' and type like 'Firmware' order by timecreate desc");
...
echo "<th>". $log['type']. "</th>";
echo "<th><a href=\"http://rynantech.com/partner-login/rynancclick.php?id=".$log['id']."\"><img src='http://www.rynantech.com/partner-login/sites/images/dl.png".$row['image_name']."'></a></th>";
echo "<th>". $log['notes']. "</th>";
echo "<th>". $log['views']. "</th>";
echo "<th>". $createDate. "</th>";
echo "<th><a href=\"rynancedit.php?id=$log[id]\"><img src='http://www.rynantech.com/partner-login/sites/images/edit.png".$row['image_name']."'></a></th>";
echo "<th><a href=\"rynancdel.php?id=$log[id]\" onclick=\"return makesure();\"><img src='http://www.rynantech.com/partner-login/sites/images/delete.png".$row['image_name']."'></a></th>";
//echo "<td>". $log['id']. "</td>";
//echo "<td>". $log['printers']. "</td>";
//echo "<td>". $log['link']. "</td>";
//echo "<td>". $log['lastupdate']. "</td>";
//echo "<td>". $log['views']. "</td>";
//echo "<td><a href=\"http://rynantech.com/partner-login/rynanc/VJET/$log[link]\" onclick=\"khoa();\">$log[link]</a></td>";
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'W1000' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'R1010' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'R1010P' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'W1020' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040H Aluminum' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040H Plastic' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040S' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040P' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1060' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1060P' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1060H' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '1200' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '1200E' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '1200Plus' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '1200EG' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '2172C' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'IOJ100' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'IOJ200' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'InkFeeder8' and type like 'Firmware' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers 
like 'R20 PRO' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'W1000' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'R1010' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'R1010P' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'W1020' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040H Aluminum' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040H Plastic' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040S' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040P' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1060' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1060P' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1060H' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '1200' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '1200E' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '1200Plus' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '1200EG' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '2172C' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'IOJ100' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'IOJ200' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'InkFeeder8' and type like 'software' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers 
like 'R20 PRO' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'W1000' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'R1010' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'R1010P' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'W1020' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040H Aluminum' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040H Plastic' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040S' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040P' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1060' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1060P' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1060H' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '1200' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '1200E' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '1200Plus' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '1200EG' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '2172C' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'IOJ100' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'IOJ200' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'InkFeeder8IOJ200' and type like 'brochure' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers 
like 'R20 PRO' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'W1000' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'R1010' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'R1010P' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'W1020' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040H Aluminum' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040H Plastic' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040S' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040P' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1060' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1060P' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1060H' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '1200' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '1200E' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '1200Plus' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '1200EG' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '2172C' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'IOJ100' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'IOJ200' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'InkFeeder8' and type like 'User Manual' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers 
like 'R20 PRO' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'W1000' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'R1010' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'R1010P' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'W1020' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040H Aluminum' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040H Plastic' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040S' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040P' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1060' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1060P' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1060H' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '1200' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '1200E' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '1200Plus' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '1200EG' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '2172C' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'IOJ100' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'IOJ200' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'InkFeeder8' and type like 'Quick Guide' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers 
like 'R20 PRO' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'W1000' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'R1010' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'R1010P' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'W1020' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040H Aluminum' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040H Plastic' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040S' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1040P' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1060' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1060P' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'B1060H' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '1200' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '1200E' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '1200Plus' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '1200EG' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like '2172C' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'IOJ100' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'IOJ200' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
//echo  @mysql_num_rows( $sql_query ); die();
$logs = @mysql_query("SELECT * from rynanc where printers like 'InkFeeder8' and type like 'Presentation' order by timecreate desc");
while($log = mysql_fetch_array( $logs )){
// Bo gio - chi lay ngay
$date = $log['timecreate'];
$createDate = date('Y-m-d', strtotime($date));
...
echo "<th>". $log['filename']. "</th>";
echo "<th>". $log['type']. "</th>";
echo "<th><a href=\"http://rynantech.com/partner-login/rynanaclick.php?id=".$log['id']."\"><img src='http://www.rynantech.com/partner-login/sites/images/dl.png".$row['image_name']."'></a></th>";
echo "<th>". $log['notes']. "</th>";
echo "<th>". $log['views']. "</th>";
echo "<th>". $createDate. "</th>";
echo "<th><a href=\"rynanaedit.php?id=$log[id]\"><img src='http://www.rynantech.com/partner-login/sites/images/edit.png".$row['image_name']."'></a></th>";
echo "<th><a href=\"rynanadel.php?id=$log[id]\" onclick=\"return makesure();\"><img src='http://www.rynantech.com/partner-login/sites/images/delete.png".$row['image_name']."'></a></th>";
//echo "<td>". $log['id']. "</td>";
//echo "<td>". $log['printers']. "</td>";
//echo "<td>". $log['link']. "</td>";
//echo "<td>". $log['lastupdate']. "</td>";
//echo "<td>". $log['views']. "</td>";
//echo "<td><a href=\"http://rynantech.com/partner-login/rynana/VJET/$log[link]\" onclick=\"khoa();\">$log[link]</a></td>";
