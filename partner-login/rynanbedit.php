...
if( isset ($_GET['edit']))
    ...
    $res = mysql_query("SELECT * FROM rynanb WHERE id='$id'");
...
<table border="0" cellpadding="0" cellspacing="0" width="977">
	...
	<div><p class="backtoindex"><a href="/partner-login/rynanbcp.php" class="hrlink"><font size="12" color="#fff" class="rightpnhome">Back to index</p></font></a></div>
...
echo "<meta http-equiv='refresh' content='0;url=/partner-login/rynanbcp.php'>";
